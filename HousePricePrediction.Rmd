...
To identify the optimal level of regularization, cross-validation is performed using a sequence of *lambda* values ranging from $10^{-10}$ to $10^{10}$ (on the log scale).  
